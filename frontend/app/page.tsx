    ...
    <section className="space-y-6">
      {showOnboarding && (
        <div className="panel space-y-3 border-cyan-300/20 bg-gradient-to-r from-cyan-500/10 to-indigo-500/10 p-5">
          ...
          <p className="text-sm text-slate-300">Use the dashboard for live market snapshots and chat for quick AI summaries.</p>
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        <div className="panel space-y-4 border-indigo-300/20 bg-gradient-to-br from-indigo-500/15 to-slate-900/70 p-6 lg:col-span-2">
          ...
          <p className="max-w-2xl text-slate-300">Track prices, trend direction, volatility risk, and compact AI commentary without heavy client libraries.</p>
        ...
        <div className="panel p-6">
          ...
          <ul className="space-y-2 text-sm text-slate-300">
            <li>• Yahoo-backed market snapshots</li>
